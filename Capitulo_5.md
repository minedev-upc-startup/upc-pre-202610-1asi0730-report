...
| **Sprint Goal & User Stories**   |                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           |
| Sprint 3 Goal                    | Nuestro objetivo es implementar capacidades transaccionales de negocio y monitoreo técnico en tiempo real para fortalecer la gestión del alquiler de maquinaria pesada dentro de MineTrack. Creemos que esto entregará un proceso más confiable y eficiente para los Owners, quienes podrán registrar maquinaria con especificaciones técnicas completas, y para los Clientes, quienes podrán buscar, filtrar y solicitar equipos según sus necesidades operativas. Además, permitirá que ambos roles accedan a información actualizada de telemetría IoT durante el periodo de alquiler, reduciendo la incertidumbre sobre el estado y uso del activo. Esto se confirmará cuando los Owners registren y administren maquinaria desde la aplicación, los Clientes busquen, filtren y envíen solicitudes de alquiler exitosamente, los Web Services expongan endpoints REST documentados mediante Swagger/OpenAPI consumidos correctamente por la Frontend Web Application, y ambos roles visualicen información técnica y telemetría IoT en tiempo real desde la versión desplegada del producto. |
| Sprint 2 Velocity                | 34 puntos                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 |
| Sum of Story Points              | 34 puntos                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 |
