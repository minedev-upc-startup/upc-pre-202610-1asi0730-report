...
| **Sprint Goal & User Stories**   |                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              |
| Sprint 2 Goal                    | **Nuestro propósito es** implementar el Frontend Web Application de MineTrack utilizando Vue.js 3, PrimeVue y una Fake API con json-server, desarrollando los bounded contexts core del producto bajo una arquitectura Domain-Driven Design. **Creemos que esto aportará** una aplicación web funcional que demuestre el flujo principal del negocio: autenticación por roles, gestión del catálogo de maquinaria y el proceso de solicitud y aprobación de alquileres. **Esto se confirmará cuando** los usuarios puedan registrarse, autenticarse con roles diferenciados (Owner / Client), navegar el catálogo de máquinas, y cuando un Cliente pueda enviar una solicitud de alquiler y un Owner pueda aprobarla, todo conectado a una Fake API desplegada públicamente. |
...
| Team Member                    | GitHub Username       | Arquitectura DDD / Scaffold (L/C) | IAM Bounded Context (L/C) | Layouts & Navigation (L/C) | Catalog Bounded Context (L/C) | Rentals Bounded Context (L/C) | Documentación (L/C) |
| ------------------------------ | --------------------- | --------------------------------- | ------------------------- | -------------------------- | ----------------------------- | ----------------------------- | ------------------- |
| Aiquipa Poma, Sebastian Andres | S-aiquipa             | **L**                             | **L**                     | **L**                      | C                             | **L**                         | C                   |
| Mendoza Machoa, Lionel         | mendozalionel745-ctrl | C                                 | C                         | C                          | **L**                         | C                             | **L**               |
| Meza Huanacuna, Juan José      | JuanMHZ12             | C                                 | C                         | C                          | C                             | C                             | **L**               |
| Figueroa Sanchez, Alvaro       | 2003V616              | C                                 | C                         | C                          | C                             | **L**                         | C                   |
| Sanchez Arenas, Zahir Emmanuel | Zahir210206           | C                                 | C                         | **L**                      | C                             | C                             | C                   |
| Molina Umeres, Nestor          | Nesthoro              | C                                 | C                         | C                          | C                             | C                             | C                   |
...
| 2        | INFRA |                              | INFRA-T003 | Fake API with json-server         | Crear server/db.json con seed data para los 7 bounded contexts (10 users, 12 machines, 8 rental requests, 5 rentals, telemetry readings, reviews). Configurar routes.json y start.sh. | 4                  | Sebastian         | Done     |
...
| 2        | INFRA |                              | INFRA-T007 | Role guard + Auth guard           | Implementar authenticationGuard y roleGuard en Vue Router. Configurar meta.requiresAuth y meta.roles por ruta.                                                                        | 2                  | Sebastian         | Done     |
| 2        | INFRA |                              | INFRA-T008 | Three role-based layouts          | Implementar topbar.vue, sidebar.vue, client-layout.vue y owner-layout.vue con navegación diferenciada por rol.                                                                        | 5                  | Sebastian         | Done     |
| 2        | INFRA |                              | INFRA-T009 | CONVENTIONS.md + README.md        | Documentar convenciones del proyecto: naming, layer rules, GitFlow, Conventional Commits, i18n, API schema ownership.                                                                 | 3                  | Sebastian         | Done     |
...
| 2        | US22  | Authenticated Login          | US22-T001  | SignIn flow + JWT storage         | Implementar SignInCommand, IamApi.findByEmail(), iam.store con persistSession() y restoreSession(). Fake JWT en localStorage.                                                         | 4                  | Sebastian         | Done     |
| 2        | US22  |                              | US22-T002  | Sign-in + Sign-up views           | Implementar sign-in-form.vue y sign-up-form.vue con validación, manejo de errores y i18n.                                                                                             | 3                  | Sebastian         | Done     |
| 2        | US01  | Public Catalog Visualization | [LLENAR]   | [LLENAR]                          | [LLENAR]                                                                                                                                                                              | [LLENAR]           | [LLENAR teammate] | [LLENAR] |
| 2        | US06  | Rental Request Submission    | [LLENAR]   | [LLENAR]                          | [LLENAR]                                                                                                                                                                              | [LLENAR]           | [LLENAR teammate] | [LLENAR] |
| 2        | US08  | Owner Incoming Requests      | [LLENAR]   | [LLENAR]                          | [LLENAR]                                                                                                                                                                              | [LLENAR]           | [LLENAR teammate] | [LLENAR] |
| 2        | US09  | Owner Approval               | [LLENAR]   | [LLENAR]                          | [LLENAR]                                                                                                                                                                              | [LLENAR]           | [LLENAR teammate] | [LLENAR] |
