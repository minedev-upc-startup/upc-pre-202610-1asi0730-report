...
| **1. Problemas del negocio** | **5. Soluciones propuestas** | **2. Resultados comerciales** |
|:---|:---|:---|
| • El mercado de alquiler de maquinaria pesada continúa operando mediante contactos personales e intermediarios informales.<br><br>• Los propietarios no cuentan con un canal digital para ofrecer sus equipos de manera segura y organizada.<br><br>• Los clientes invierten demasiado tiempo buscando maquinaria disponible y verificando su estado técnico.<br><br>• No existe una plataforma que centralice el proceso de alquiler y el monitoreo de los equipos. | • Marketplace web para publicar y alquilar maquinaria pesada.<br><br>• Catálogo digital con filtros de búsqueda por tipo, ubicación y disponibilidad.<br><br>• Gestión de solicitudes, aprobación y contratos de alquiler.<br><br>• Dashboard IoT para visualizar temperatura, vibración y presión hidráulica en tiempo real.<br><br>• Sistema de alertas preventivas basado en telemetría. | • Incrementar la cantidad de alquileres concretados mediante la plataforma.<br><br>• Reducir el tiempo necesario para encontrar maquinaria disponible.<br><br>• Incrementar la ocupación de la flota de los propietarios.<br><br>• Posicionar a MineTrack como el marketplace de referencia para el alquiler de maquinaria pesada.<br><br>• Generar ingresos mediante comisiones por alquiler exitoso. |

| **3. Usuarios y Clientes** | **4. Beneficios para el usuario** | **6. Hipótesis** |
|:---|:---|:---|
| **Propietarios de maquinaria pesada**<br>Empresas contratistas e independientes que desean alquilar sus equipos para maximizar el uso de sus activos.<br><br>**Clientes**<br>Empresas mineras y constructoras que necesitan maquinaria pesada para proyectos temporales sin adquirirla permanentemente. | **Para los Propietarios**<br>• Mayor visibilidad de sus equipos.<br>• Gestión digital de solicitudes y contratos.<br>• Seguimiento del estado de sus activos mediante IoT.<br><br>**Para los Clientes**<br>• Acceso rápido a maquinaria disponible.<br>• Información técnica confiable.<br>• Monitoreo del equipo durante el alquiler.<br>• Proceso de alquiler simple y transparente. | • Reduciremos el tiempo de inactividad de la flota en **30 %** mediante la publicación digital de maquinaria.<br><br>• Los clientes podrán alquilar maquinaria verificada en menos de **48 horas**.<br><br>• El monitoreo IoT aumentará la confianza entre propietarios y clientes.<br><br>• Las alertas preventivas reducirán el tiempo de inactividad no programado en **20 %**. |

| **7. ¿Qué es lo más importante que debemos aprender primero?** | **8. ¿Cuál es la menor cantidad de trabajo que necesitamos hacer para aprender lo siguiente más importante?** |
|:---|:---|
| • Validar que los propietarios estén dispuestos a publicar sus equipos en una plataforma digital.<br><br>• Confirmar que las empresas mineras y constructoras confiarán en un marketplace para alquilar maquinaria.<br><br>• Evaluar si el monitoreo IoT representa un valor diferencial durante el alquiler.<br><br>• Verificar la aceptación del modelo basado en comisiones por alquiler. | • Desarrollar un MVP con el catálogo de maquinaria y el flujo de solicitudes.<br><br>• Implementar un dashboard básico de monitoreo IoT con datos simulados.<br><br>• Realizar pruebas de usabilidad con propietarios y clientes.<br><br>• Recoger retroalimentación para validar las hipótesis y mejorar la plataforma. |
